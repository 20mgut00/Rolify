        ...
        <div className="max-w-2xl mx-auto mb-12 space-y-4">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-10 pr-4 py-3 border border-primary-dark/20 rounded-lg focus:ring-2 focus:ring-accent-gold focus:border-transparent bg-white appearance-none cursor-pointer"
            >
